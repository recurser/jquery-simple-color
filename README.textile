...
If you come across any problems, please "create a ticket":http://recursive-design.com/code/p/jquery-simple-color/issues/ and we'll try to get it fixed as soon as possible.
